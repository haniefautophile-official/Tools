...
IZIN_URL="https://raw.githubusercontent.com/haniefautophile-official/udp-zivpn/main/izin_ips.txt?v=$(date +%s)"
...
sudo wget https://github.com/haniefautophile-official/udp-zivpn/releases/download/udp-zivpn_1.4.9/udp-zivpn-linux-amd64 -O /usr/local/bin/zivpn-bin
sudo chmod +x /usr/local/bin/zivpn-bin
sudo mkdir -p /etc/zivpn
sudo wget https://raw.githubusercontent.com/haniefautophile-official/udp-zivpn/main/config.json -O /etc/zivpn/config.json
...
sudo wget -O /usr/local/bin/zivpn https://raw.githubusercontent.com/haniefautophile-official/udp-zivpn/main/zivpn-menu.sh
sudo chmod +x /usr/local/bin/zivpn

# Unduh skrip uninstall dan letakkan di path yang dapat diakses
sudo wget -O /usr/local/bin/uninstall.sh https://raw.githubusercontent.com/haniefautophile-official/udp-zivpn/main/uninstall.sh
sudo chmod +x /usr/local/bin/uninstall.sh

# Pasang skrip pembersihan otomatis dan jadwalkan
sudo wget -O /usr/local/bin/zivpn-cleanup.sh https://raw.githubusercontent.com/haniefautophile-official/udp-zivpn/main/zivpn-cleanup.sh
...
sudo wget -O /usr/local/bin/zivpn-monitor.sh https://raw.githubusercontent.com/haniefautophile-official/udp-zivpn/main/zivpn-monitor.sh
...
sudo wget -O /etc/profile.d/zivpn-motd.sh https://raw.githubusercontent.com/haniefautophile-official/udp-zivpn/main/zivpn-motd.sh
