...
display_license_info_content() {
    ...
    if [ -f "$LICENSE_FILE" ]; then
        ...
        printf " Build By   : @Dark_System2x    Partner: @hanief_autophile\n"
        echo "==========================================================="
    fi
}
...
update_script() {
    ...
    # --- Configuration ---
    REPO_URL="https://raw.githubusercontent.com/haniefautophile-official/udp-zivpn/main"
    # Assuming the release version might get updated, but for now, this is the latest known one.
    RELEASE_URL="https://github.com/haniefautophile-official/udp-zivpn/releases/download/udp-zivpn_1.4.9"
